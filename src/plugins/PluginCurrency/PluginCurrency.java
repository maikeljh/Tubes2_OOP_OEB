...
public class PluginCurrency extends SettingsDecorator implements Serializable{
    ...
    public void execute(){
        ...
        try {
            ...
            Currency currentCurrency = currencyDataStore.loadData("currentCurrency", this.page.getSettings(), new Class<?>[]{Inventory.class, Currency.class}).getElement(0);
            this.currency = currentCurrency.getCurrency();
            this.currentKurs = currentCurrency.getKurs();
        } catch (Exception e){
            // Do Nothing
        }
        ...
        optionButton.setOnAction(event -> {
            ...
            formatOptions.valueProperty().addListener((observable, oldValue, newValue) -> {
                ...
                Inventory<Currency> tempCurrency = new Inventory<>();
                tempCurrency.addElement(new Currency(this.currency, this.currentKurs));
                currencyDataStore.saveData("currentCurrency", this.page.getSettings(), new Class<?>[]{Inventory.class, Currency.class}, tempCurrency);
