...
//            lineSeries.getData().add(new XYChart.Data<>(this.items.getElement(i).getName(), this.items.getElement(i).getQuantity()));
//        }
...
//        for (int i = 0; i < this.items.getNeff(); i++){
//            barSeries.getData().add(new XYChart.Data<>(this.items.getElement(i).getName(), this.items.getElement(i).getQuantity()));
//        }
