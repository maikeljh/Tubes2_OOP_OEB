...
public class CashierDetailPage extends Page {
    ...
    public CashierDetailPage(Stage stage, Tab tab, Item item, Inventory<PurchasedItem> purchasedItems, Inventory<Item> items, TabPane tabPane, Inventory<Customer> customers, Integer mode, boolean usePoint, RegisteredCustomer regisCust, Settings settings, DataStore<Settings> settingsDS, SalesReport report){
        ...
        addButton.setOnAction(event -> {
            processAdd();
            CashierPage cashierContent = new CashierPage(stage, tab, items, tabPane, customers, mode, purchasedItems, usePoint, regisCust, settings, settingsDS, report);
